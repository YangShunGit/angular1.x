		...
		app.controller("emailCtlr",["$scope","$state","UpuserService",function($scope,$state,UpuserService){
			
			/*返回上一步*/
			$scope.cancel = function(){
				window.history.go(-1);
			}
			//$scope.email_info=JSON.parse(sessionStorage.getItem("person_info"));
			$scope.email =UserInfo.usermail;
