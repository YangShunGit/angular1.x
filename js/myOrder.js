		...
		app.controller("myOrderCtlr", ["$scope", "$timeout", "swiper","$state","OrdersService","CancelorderService","ReturnfororderService","AppagainService","BugagainService","OrdersignService","StatesService",function($scope, $timeout,swiper,$state,OrdersService,CancelorderService,ReturnfororderService,AppagainService,BugagainService,OrdersignService,StatesService) {
			/*返回上一步*/
