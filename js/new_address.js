		...
		app.controller("new_addressCtlr", ["$scope","$timeout", "$state","EditaddrService","OrganizesService","AreaService", function($scope,$timeout, $state,EditaddrService,OrganizesService,AreaService) {
				/*返回上一步*/
		...
		$(".cost_sel_wrapper").on("click",".sel_list li", function() {
			...
			console.log($(this).children(".sel_draw"));
