		...
		app.controller("categoryCtlr",["CategoryDataService","$scope","$timeout","$state","SearchDataService", function(CategoryDataService,$scope,$timeout,$state,SearchDataService){
			...
			var mycategorydata = CategoryPostData("1");
